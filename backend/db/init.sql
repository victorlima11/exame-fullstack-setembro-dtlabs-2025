...
CREATE TABLE heartbeats (
    ...
    device_sn VARCHAR(12) NOT NULL REFERENCES devices(sn) ON DELETE CASCADE,
...
CREATE TABLE notification_rules (
    ...
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    device_sn VARCHAR(12) REFERENCES devices(sn) ON DELETE CASCADE,
...
CREATE INDEX idx_notification_rules_device ON notification_rules(device_sn);
CREATE INDEX idx_notifications_user ON notifications(user_id);
CREATE INDEX idx_notifications_device ON notifications(device_sn);